...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-hidden relative">
      {/* Background elements */}
<div className="absolute inset-0 pointer-events-none bg-[radial-gradient(at_50%_30%,rgba(236,72,153,0.15),transparent)]" />
      <FloatingHearts />
            ...
            <div className="max-w-2xl w-full">
              ...
              <div className="flex justify-center mt-12">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={nextStage}
                  className="px-16 py-6 rounded-2xl border border-white/30 hover:bg-white/5 flex items-center gap-3 text-lg transition-all"
                >
